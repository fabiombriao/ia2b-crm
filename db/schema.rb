...
ActiveRecord::Schema[7.1].define(version: 2026_04_16_000717) do
  ...
  create_table "contact_companies", id: false, force: :cascade do |t|
    t.bigint "contact_id", null: false
  ...
  create_table "crm_companies", force: :cascade do |t|
    ...
    t.index ["name", "account_id"], name: "index_crm_companies_on_name_and_account_id", unique: true
  end
  ...
  create_table "crm_pipelines", force: :cascade do |t|
    ...
    t.index ["name", "account_id"], name: "index_crm_pipelines_on_name_and_account_id", unique: true
  end
